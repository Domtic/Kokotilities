...
namespace ElectricSheep.Utility
{
    /// <summary>
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapSceneOnPlay = "BootStrap/Load Bootstrap Scene On Play";
        private const string k_DoNotLoadBootstrapSceneOnPlay = "BootStrap/Don't Load Bootstrap Scene On Play";
            ...
            if (playModeStateChange == PlayModeStateChange.ExitingEditMode)
            {
                ...
                if (EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo())
                {
                        ...
                        Array.Exists(EditorBuildSettings.scenes, scene => scene.path == BootstrapScene))
                    {
                        ...
                        s_RestartingToSwitchScene = activeScene.path == string.Empty ||
